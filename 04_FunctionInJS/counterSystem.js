/**
 * Create a Counter system using an Immediately Invoked Function Expression (IIFE) to encapsulate a private variable and 
 * provide methods to interact with it. The system should include two methods, increment and decrement, 
 * which will increase and decrease the count respectively and return messages displaying the updated count.
