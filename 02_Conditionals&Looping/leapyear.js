/**
 * Write a program that checks whether a given year is a leap year. The program should follow specific rules to determine 
 * if a year is a leap year and store the result as a boolean value (true or false) in a variable named answer.
 * 
 * 
 * 
